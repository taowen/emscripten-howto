...
function call_js() { try { Module._call_back_wasm(); } catch(e) { if (e.getArg && Module.getExceptionMessage) { const [exType, exMsg] = Module.getExceptionMessage(e); console.log(exType, exMsg, e.stack); } } }
...
/** @type {function(...*):?} */
var _call_back_wasm = Module["_call_back_wasm"] = createExportWrapper("call_back_wasm");
